...
<nav class="bg-white shadow" x-data="{
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="mobileOpen">
        <div class="pt-2 pb-4 space-y-1">
            <a href="{{ route('overview') }}"
               class="block py-2 pl-3 pr-4 text-base font-medium text-gray-500 border-l-4 border-transparent hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700">Tours</a>

            @if(auth()->user()->is_admin)
                <a href="{{ route('admin.view_user') }}"
                   class="block py-2 pl-3 pr-4 text-base font-medium text-gray-500 border-l-4 border-transparent hover:border-gray-300 hover:bg-gray-50 hover:text-gray-700">Users</a>
            @endif
        </div>
    </div>
