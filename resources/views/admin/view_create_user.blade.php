...
@section('content')
    <div class="custom-container mx-auto pt-4">
        <div class="max-w-md mx-auto bg-white rounded p-6 shadow-md">
            <h2 class="text-2xl font-semibold mb-4">{{ __('Gebruiker Aanmaken') }}</h2>
            ...
            <form method="POST" action="{{ route('admin.create_user') }}">
                ...
                <div>
                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md">{{ __('Gebruiker Aanmaken') }}</button>
                </div>
            </form>
        </div>
    </div>
