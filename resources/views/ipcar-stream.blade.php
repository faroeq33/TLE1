        ...
        <div id="landscape">
            ...
            <div id="toggleButtons">
                ...
                <button id="cameraToggle">
                    <img src="{{ asset('storage/icons/webcam_blue.png') }}" alt="Camera icon" width="19" height="19"
                        class="pointer-events-none" id="cameraIcon">
                </button>

                <!-- Toggle Mic On/Off button -->
                <button id="micToggle">
                    <img src="{{ asset('storage/icons/microphone_blue.png') }}" alt="Microphone icon" width="19"
                        height="19" class="pointer-events-none" id="micIcon">
                </button>

                <!-- Trigger/Open The Modal -->
                @auth
                    <button id="controllerButton">
                        <img src="{{ asset('storage/icons/question_mark_blue.png') }}" alt="Help icon" width="19"
                            height="19" class="pointer-events-none" id="helpIcon">
                    </button>
