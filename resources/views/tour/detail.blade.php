    ...
    <div class="container mx-auto">
        ...
        <table class="min-w-full bg-white border border-gray-300">
            <tr>
                ...
                <td class="px-4 py-2 text-center border-b">Terug naar overzicht</td>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2 text-center border-b">
                        <form method="GET" action="{{ route('overview') }}" class="inline">
                            @csrf
                            @method('GET')
                            <button class="px-2 py-1 text-white bg-blue-500 rounded hover:bg-blue-700" type="submit">Terug naar overzicht</button>
                        </form>
                    </td>
                    <td class="px-4 py-2 text-center border-b">
